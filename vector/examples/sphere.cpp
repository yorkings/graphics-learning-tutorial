...
bool ray_hit_sphere(const vec3 &center,float radius,const Ray &r){
...
vec3 color(const Ray &r){
    if(ray_hit_sphere(vec3(0.0,0.0,-1.0),0.5,r))return  vec3(0.0,0.0,-1.0);
...
int main(){
    ...
    std::ofstream image("../data/image_sphere_" + get_current_time() + ".ppm",std::ios::binary);
    image << "P6\n" << nx << " " << ny << "\n255\n";
